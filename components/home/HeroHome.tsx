        ...
        <div className="pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="md:grid md:grid-cols-12 md:gap-12 lg:gap-20 items-center">
            ...
            <div className="md:col-span-6 lg:col-span-6 mb-8 md:mb-0 text-center md:text-left">
              <h1 className="h2 lg:text-3xl mb-4 text-indigo-800 dark:text-white font-extrabold">
                Your Handwritten<br/>Signatures as NFTs</h1>
              <p className="text-xl text-gray-600 dark:text-gray-400">Create an NFT of your handwritten signature.  Use it to sign assets and documents.</p>
              {/* CTA form */}
              <form className="mt-8">
                <div className="flex flex-col sm:flex-row justify-center max-w-sm mx-auto sm:max-w-md md:mx-0">
                  <Link className="btn text-white bg-indigo-500 hover:bg-indigo-400 shrink-0" href="/create-signature">Get Started</Link>
                </div>
                {/* Success message */}
                {/* <p className="text-center md:text-left mt-2 opacity-75 text-sm">Thanks for subscribing!</p> */}
              </form>
              <ul className="max-w-sm sm:max-w-md mx-auto text-left md:max-w-none text-gray-600 dark:text-gray-400 mt-8 -mb-2" data-aos="fade-down" data-aos-delay="450">
